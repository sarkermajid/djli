            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
                    <div class="icon-box iconbox-blue">
                        ...
                        <p>A well-prepared interview can make all the difference in securing your place at a top university
                            or language school. Our expert guidance includes mock interviews, commonly asked questions, and
                            strategies to present yourself confidently. We focus on improving your communication skills,
                            body language, and responses to ensure you leave a lasting impression on the admission panel.
                        </p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
                ...
                <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
                    <div class="icon-box iconbox-blue">
                        ...
                        <p>Finding the right place to stay is crucial for a comfortable study experience. We help you
                            explore different accommodation options, whether it's university dormitories, shared apartments,
                            or homestays. Our team assists in finding safe, affordable, and convenient housing based on your
